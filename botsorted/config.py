...
config = {
    ...
    else "HEROKU_POSTGRESQL_COBALT_URL",
    "exchange": "Binance",
    "execute_strat": False,
    "interval": "1d",
    "extraCharts": [
        {
            "modelName": "Reggie",
            "modelVersion": "1.0",
            "modelLocation": "botsorted/ml/static/1d-fut-7.json",
            "description": "First iteration of the main Bitcoin futures model",
        },
        {
            "modelName": "LiteKeezy",
            "modelVersion": "1.0",
            "modelLocation": "botsorted/ml/static/grid-boy-ltc.json",
            "description": "First iteration of an LTC futures trading agent",
        },
    ],
    "logLevel": "info",
    ...
    "runTrader": True
    if DEPLOY_ENV == "HEROKU"
    else False,  # only run the trader on the remote host, not locally as likely testing other stuff
    "sleepInterval": 20,
